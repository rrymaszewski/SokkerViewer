...
public class AbstractDownloader {
	...
	protected HttpURLConnection getDefaultConnection(String urlString, String type, Proxy proxy, String proxyAuth) throws IOException {
		...
		if (proxyAuth != null) {
			connection.setRequestProperty("Proxy-Authorization", "Basic " + proxyAuth); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return connection;
	}

	protected HttpURLConnection getDefaultConnection(String urlString, Proxy proxy) throws IOException {
