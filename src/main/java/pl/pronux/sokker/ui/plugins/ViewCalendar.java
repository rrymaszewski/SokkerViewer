...
//		groupCalendar.setText(langResource.getString("calendar"));
...
//		calendar = new SWTCalendar(groupCalendar, SWTCalendar.RED_SUNDAY);
...
//				getDayEvents(calendar.getCalendar());
//			}
//
//		});
	...
	private String formatDate(Calendar cal) {
		return cal.get(Calendar.YEAR) + "-" + doubleDigitFormat.format((cal.get(Calendar.MONTH) + 1)) + "-" + doubleDigitFormat.format(cal.get(Calendar.DAY_OF_MONTH));
	}
	...
	private void getDayEvents(Calendar calendar) {
		...
		group.setText(Messages.getString("training.season") + " " + season.getSeasonNumber() + " " + Messages.getString("training.week") + " " + season.getSeasonWeek());
