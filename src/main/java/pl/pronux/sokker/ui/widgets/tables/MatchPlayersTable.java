...
public class MatchPlayersTable extends SVTable<PlayerStats> implements IViewSort<PlayerStats> {
	...
	public MatchPlayersTable(Composite parent, int style) {
		...
		String[] columnsTooltips = {
									Messages.getString("table.match.substitutions.tooltip"), Messages.getString("table.match.number.tooltip"), Messages.getString("table.match.player.tooltip"),   
		...
		String[] columns = {
							" ", Messages.getString("table.match.number"), Messages.getString("table.match.player"), Messages.getString("table.match.formation"),    
